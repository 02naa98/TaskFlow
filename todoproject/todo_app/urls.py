...
from .views import TaskCreateView,TaskListView,TaskUpdateView,TaskDeleteView,ListCreateView,ListUpdateView,ListDeleteView,TaskFilterView,ToggleStarView
...
urlpatterns = [
    ...
    path('tasks/filter/', TaskFilterView.as_view(), name='task_filter'), #フィルター表示
    #動的url(ページ遷移が小さい)
